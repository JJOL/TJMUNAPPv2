...
function init () {
    ...
    const SENATE_FLAG_IMG_PATH = '../common/assets/senate_flag.jpg';
    ...
    imageFlagCont = new ImageFlagComponent('#flagImg-component', language, SENATE_FLAG_IMG_PATH, unsession.imgFlagPath)
    ...
    speakerListCont.onCurrentSpeakerChanged((delegate) => {
        if (delegate) {
            ...
            unsession.imgFlagPath = SENATE_FLAG_IMG_PATH;
        }
